<template>
    <v-container >
        ...
        justify="center" align="center">Datos de envío
        <p></p>
                <v-img src="../assets/casa.png" height="50" contain></v-img>
        </h2>
           ...
           <v-expansion-panels>
                <v-expansion-panel>
                    ...
                    <v-expansion-panel-content>
                        <v-row>
                            <v-col cols="8">
                                <!-- decription reference id_section-->
                                <v-text-field v-model="direccion" color="pink" placeholder="Dirección"></v-text-field>
                            </v-col>
                            <v-col cols="4">
                        ...
                        <v-row>
                            <v-col cols="12">
                                <v-text-field v-model="referencia" color="pink" placeholder="Referencia"></v-text-field>
                            </v-col>
                        </v-row>
                         <!-- MAPAAAAAA-->
                        <v-row>
                ...
                <!--pago id pago físico =4 , visa=2-->
                <v-expansion-panel>
                    <v-expansion-panel-header>
                        <template v-slot:default="{ open }">
                        <v-row no-gutters>
                            <v-col cols="4">Forma de pago</v-col>
                            <v-col
                            cols="8"
                            class="text--secondary"
                            >
                    ...
                    <v-expansion-panel-content>
                        <v-row>
                            <v-col cols="8">
                                <v-radio-group v-model="radio" :mandatory="false" row>
                                    <v-radio label="Pago en efectivo" value="e" color="pink"></v-radio>
                                    <v-radio label="Pago con tarjeta" value="t" color="pink"></v-radio>
                                </v-radio-group>
                            </v-col>
                        </v-row>
                        <v-row>
                            <v-col v-if="radio=='t'">
                             ...
                             <div class="wrapper">
                                ...
                                <div class="card-list">
                                    ...
                                    <div class="card-item__side -front">
                                        ...
                                        <div class="card-item__content">
                                            ...
                                            <div class="card-item__holder">Propietario de la tarjeta</div>
                                            <transition name="slide-fade-up">
                                            ...
                                            <label for="cardMonth" class="card-item__dateTitle">Expiración</label>
                                ...
                                <div class="card-form__inner">
                                    ...
                                    <div class="card-input">
                                    <label for="cardName" class="card-input__label">Propietario de la tarjeta</label>
                ...
                <v-btn color="info" block @click="save">Confirmar pedido</v-btn>
            </v-expansion-panels>   
        <!--Dialog-->
...
export default {
    ...
    //tarjetaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
     mounted() {
  ...
  methods: {
    ...
    async save(){
      ...
      for(let i=0; i<platos.length; i++){
        let orderDetailPlate2 = {
          plate:{
            id: platos[i].id
          },
          nunit:3
        }
        orderDetailPlate.push(orderDetailPlate2)
      }
      console.log(orderDetailPlate)
      const entrada = {
        payed : this.pagado,
        description: "en envio",
      //  descriptionRating: "bueno",
        puntuationRating: 0,
        restaurantAccount:{
          id: 4,
        },
      ...
      console.log(entrada)
      try{
        const entradaDB = await this.axios.post('v1/order',entrada)
        console.log(entradaDB)
        this.dialog= true
      } catch(error){
        console.log(error)
      }
